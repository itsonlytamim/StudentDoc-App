...
@Component({
  templateUrl: './voter-id-card.component.html',
  styleUrls: ['./voter-id-card.component.css']
})
export class VoterIdCardComponent implements OnInit {
  documents: Document[] = [];
  folderName: string = 'voter-id-card'; // Replace with the folder name you want to fetch
